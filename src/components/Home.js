...
import { features, blogPosts } from "./homeData";
  ...
  return (
    <div className="relative bg-white py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
        <h2 className="text-base font-semibold tracking-wider text-cyan-600 uppercase">
          Create Albums faster
        </h2>
        <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
          Everything you need to share wedding photos
        </p>
        <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
          Create personalized albums for everyone in your wedding.
        </p>
        <div className="mt-12">
      ...
      <div className="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
        <div className="md:ml-auto md:w-1/2 md:pl-10">
          ...
          <p className="mt-3 text-lg text-gray-300">
            Provide your email and we will update you of our progress
            periodically and provide early access.
          </p>
          {/* <div className="mt-8">
          ...
          <div className="mt-10 sm:mt-12">
            <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
              ...
              <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                Free 14-day early access, no credit card necessary. Access
                provided on a first-come first-available basis. By providing
            ...
            <div className="lg:py-24">
              ...
              <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                ...
                <span className="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">
                  share wedding albums
                </span>
              </h1>
              <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                Create personalized wedding albums for each person in the
                wedding. Increase your reach, extend your potential!
              </p>
              {/* <div className="mt-10 sm:mt-12">
              <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                <div className="sm:flex">
